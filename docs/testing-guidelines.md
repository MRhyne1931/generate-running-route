...
This document outlines the testing strategy and best practices for the route app. We follow a comprehensive testing approach that ensures code quality, maintainability, and reliability across the entire application.
...
export const mockRoutes = [mockRoute, { ...mockRoute, id: '2', title: 'Another Route' }];
```
