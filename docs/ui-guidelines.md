...
- **Elements**:
  - Title input field (placeholder: "Add a new route...")
  - "Add" button
  - Layout: Title field full-width and button on second row
- **Spacing**: `md` bottom margin to separate from todo list

### Route List Section
- **Container**: Scrollable list with `lg` top spacing
- **Empty State**: Display message "No routes yet. Add one to get started! 👻" when list is empty
...
- **Content Area**: Middle section with title
