...
This project is a full-stack JavaScript application used to generate random running routes. It consists of a React frontend and a Node.js/Express backend, organized in a monorepo structure using npm workspaces.
